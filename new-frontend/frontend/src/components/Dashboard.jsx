...
const Dashboard = () => {
  // Use live API mode (false) while keeping minTime and maxTime from upstream destructuring
  const { data, loading, error } = useSensorData(false); 
  ...
  // Validation logic for invalid time range
  ...
  // Handle form submission with time range validation
  const handleSubmit = () => {
  ...
  return (
    <div className="dashboard-page">
      ...
      <section className="dashboard-section controls-panel">
        ...
        {/* Alert message shown when an invalid time range is selected */}
        {hasInvalidTimeRange && (
          <p style={{ color: '#b00020', fontWeight: 600, padding: '0 15px' }}>
